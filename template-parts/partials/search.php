...
?>
<div class="site_search<?php if ($modifier) echo " site_search_$modifier"; ?>" id="site_search<?php if ($modifier) echo "_$modifier"; ?>" itemscope itemtype="http://schema.org/WebSite" role="search">
	<meta itemprop="url" content="<?php Boilerplate::drawDomain(); ?>">
